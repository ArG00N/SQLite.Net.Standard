...
namespace SQLite.Net.Platform.WinRT
{
    public class SQLiteApiWinRT : ISQLiteApiExt
    {
        ...
        public SQLiteApiWinRT(string tempFolderPath, bool useWinSqlite = true)
        {
            _useWinSqlite = useWinSqlite;

            if (_useWinSqlite)
            {
                WinSQLite3.SetDirectory(/*temp directory type*/2, tempFolderPath);
            }
            else
            {
                SQLite3.SetDirectory(/*temp directory type*/2, tempFolderPath);
            }
        }
